...
public interface AuthService {
    ...
    /** [Admin] Suspend a user account — user cannot log in while suspended. */
    void suspendUser(Long userId);

    /** [Admin] Lift a suspension and reactivate the user account. */
    void reactivateUser(Long userId);

    /** [Admin] Permanently delete a user record from the database. */
    void permanentlyDeleteUser(Long userId);

    /** [Admin] Aggregate user metrics for platform dashboards. */
