...
class GlobalExceptionHandlerTest {
    ...
    void handleNotFound_returns404() {
        ResponseEntity<Map<String, Object>> response = handler.handleNotFound(new ResourceNotFoundException("Comment not found"));
    ...
    @Test
    void handleValidation_returns400WithFieldMessage() throws NoSuchMethodException {
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(new Object(), "commentRequest");
        bindingResult.addError(new FieldError("commentRequest", "text", "must not be blank"));
        ...
        assertTrue(message.contains("text: must not be blank"));
    }
